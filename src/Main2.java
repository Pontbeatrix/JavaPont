...
//4.Scrieti o metoda java, care sa primeasca 3 parametrii de tip numar, si sa returneze media numerelor.
        ...
        public static int punct4 ( int primulnumar, int aldoileanumar, int altreilanumar ){
            return primulnumar + aldoileanumar + altreilanumar /3;
        }
...
//6.Scrieti o metoda java, care sa returneze restul impartirii a doua numere
        ...
        public static float punct6 ( int s, float e){
            return s % e;
        }
